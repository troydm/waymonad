...
foreign import ccall safe "wlr_cursor_absolute_to_layout_coords" c_absolute_to_layout_coords :: Ptr WlrCursor -> Ptr InputDevice -> Double -> Double -> Ptr Double -> Ptr Double -> IO Word8
