...
foreign import ccall safe "wlr_backend_is_libinput" c_is_libinput :: Ptr Backend -> IO Word8

backendIsLibinput :: Ptr Backend -> IO Bool
backendIsLibinput = fmap (/= 0) . c_is_libinput

foreign import ccall safe "wlr_input_device_is_libinput" c_input_is_libinput :: Ptr InputDevice -> IO Word8

inputDeviceIsLibinput :: Ptr InputDevice -> IO Bool
inputDeviceIsLibinput = fmap (/= 0) . c_input_is_libinput

foreign import ccall safe "wlr_libinput_get_device_handle" c_get_handle :: Ptr InputDevice -> IO LI.InputDevice
